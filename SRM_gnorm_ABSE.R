...
simulatedbatch_ABSE<-foreach(batchnumber =c((1:length(allkurtgnorm))), .combine = 'rbind') %dopar% {
  ...
  for (batch1 in c(1:batchsize)){
    ...
    allrawmoBias<-c(
      firstbias=(c(Huberx,SMWM9,midhinge1,SWA81,SWAHlmean1,rqm1,MoM2=MoM2,MoM3=MoM3,MoM4=MoM4,MoM5=MoM5,MoRM2=MoRM2,MoRM3=MoRM3,MoRM4=MoRM4,MoRM5=MoRM5)-targetm)
    )
    
    all1<-t(c(kurtx,Huberx,SMWM9,midhinge1,SWA81,SWAHlmean1,rqm1,MoM2=MoM2,MoM3=MoM3,MoM4=MoM4,MoM5=MoM5,MoRM2=MoRM2,MoRM3=MoRM3,MoRM4=MoRM4,MoRM5=MoRM5,targetall,momentsx,allrawmoBias))
  ...
  ratiomean1<-c(SEbatachesmean[c(1:60)])/SEbatachesmean[57]
...
simulatedbatch_ABSE_SE<-foreach(batchnumber =c((1:length(allkurtgnorm))), .combine = 'rbind') %dopar% {
  ...
  meansd_unscaled1<-apply((SEbataches[1:batchsize,c(1:60)]), 2, se_sd)
  ...
  allErrors<-c(samplesize=samplesize,kurt=SEbatachesmean[1],se_mean=se_mean_all1,SEbatachesmean=SEbatachesmean,ratiomean1=ratiomean1,meansd_unscaled1=meansd_unscaled1,mean_SE1=mean_SE1)
